...
public class Persona {
    ...
    private final ObjectProperty fechaNacimiento;
    ...
    public Persona(String nombre, String apellidos){
        ...
        this.fechaNacimiento = new SimpleObjectProperty(LocalDate.of(1974, 6, 15));
    }
    ...
    public LocalDate getFechaDeNacimiento() {
        return (LocalDate) fechaNacimiento.get();
    }

    public void setFechaDeNacimiento(LocalDate fechaDeNacimiento) {
        this.fechaNacimiento.set(fechaDeNacimiento);
    }
